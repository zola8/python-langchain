...
def main():
    ...
    seeds = list(range(10))
    trials = 2  # lower this if you don't want to wait as long, 1 is fine "just to see"
...
# https://github.com/mCodingLLC/VideosSampleCode/blob/master/videos/040_how_fast_is_pythons_sort_performance_testing/how_fast_is_sort.py
